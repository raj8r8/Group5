...
<header id="loader">
    ...
    <h1>Edit Student</h1>
            ...
            <form action="student_edit.php" id="edit" method="POST">
                ...
                <br/>
               <label>Username:</label><input class="form-control" type="text" name="name" value="<?=$_POST["name"]?>">
                 <br/>
                <label>Ban Status:</label>
                <select class='form-control' name='ban_status' id='ban_status'>
                    <?php
                        echo "<option value='0' selected=".$_POST["isBanned"] == 0 ? 'selected' :''">Not Banned</option>";
                        echo "<option value='1' selected=".$_POST["isBanned"] != 0 ? 'selected' :''">Banned</option>";
                    ?>
                </select>
